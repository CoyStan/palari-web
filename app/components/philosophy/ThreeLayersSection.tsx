            ...
            <FadeIn key={layer.label}>
              <div className="relative flex items-start gap-5">
                ...
                <div className={`flex-1 rounded-[24px] p-6 ${layer.accent}`}>
                  ...
                  <p
                    className={`mt-2 text-base leading-relaxed ${i === 0 ? "text-white/80" : "text-[#535778]"}`}
                    dangerouslySetInnerHTML={{ __html: layer.description }}
                  />
                  <p
                    className={`mt-2 text-sm italic ${i === 0 ? "text-white/50" : "text-[#5B5E84]/60"}`}
                    dangerouslySetInnerHTML={{ __html: layer.detail }}
                  />
