...
const palaris: PalariProfile[] = [
  {
    ...
    backstory:
      "Grew up watching her mother trace typography with a magnifying glass. Sees structure inside the mess.",
    dot: "bg-[#F46F61]",
  ...
  },
  {
    ...
    backstory:
      "Learned patience in his grandfather\u2019s watchmaking shop. Notices what others miss.",
    dot: "bg-[#22B8B0]",
  ...
  },
  {
    ...
    backstory:
      "NHS data analyst\u2019s kid. Learned early that good notes save lives.",
    dot: "bg-[#E7B83D]",
  ...
  },
  {
    ...
    backstory:
      "Raised above a printing press. Grew up hearing its rhythm through the floor.",
    dot: "bg-[#9B4FCC]",
  ...
  },
  {
    ...
    backstory:
      "Left a tech job over a dark-pattern mandate. Came back with clearer principles.",
    dot: "bg-[#4CAF50]",
  ...
  },
  {
    ...
    backstory:
      "Grew up obsessed with the hidden pipe systems that kept his city alive.",
    dot: "bg-[#2E2A7B]",
  ...
  },
  {
    ...
    backstory:
      "A kintsugi bowl taught her that noticing breakage is the beginning of understanding.",
    dot: "bg-[#F46F61]",
