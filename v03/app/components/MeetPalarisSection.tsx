...
const palaris = [
  {
    ...
    voice:
      "found it \u2014 3 tests failing in auth, all hitting that token_lifetime refactor from tuesday. fix is a default value. want me to push?",
    dot: "bg-[#F46F61]",
  ...
  },
  {
    ...
    voice:
      "Sofia shipped the auth refactor last night. Leo\u2019s API handler still expects the old token format. Left him a note. Two items need your call today.",
    dot: "bg-[#E7B83D]",
  ...
  },
  {
    ...
    voice:
      "button spacing feels cramped on mobile. bumped padding 4px, slowed the transition to 200ms. rhythm\u2019s better now. take a look",
    dot: "bg-[#9B4FCC]",
      ...
      <div className="mx-auto max-w-7xl px-6 md:px-10">
        <FadeIn>
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mt-4 text-lg text-[#4A4D73]">
              Generic assistants give generic feedback. Each Palari is a domain
              expert with scoped access and a distinct voice &mdash; so the
              reviews, the escalations, and the handoffs are specific to your
              project.
            </p>
          </div>
        </FadeIn>
        ...
        <FadeIn>
          <p className="mx-auto mt-10 max-w-2xl text-center text-sm italic leading-relaxed text-[#5B5E84]">
            Voice is how you know the memory is working. Same model underneath
            &mdash; specific person on top.
          </p>
        </FadeIn>
